...
- author: apod
  platform: mastodon
  quality_score: 0.5229999999999999
...
<!-- SVG: SVG scientific process diagram for Types of Gravitational Lensing -->
<figure>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
  ...
  <text x="150" y="110" text-anchor="middle">Strong Lensing</text>
  
  <!-- Weak Lensing step -->
  <rect x="550" y="50" width="200" height="100" class="step" />
  <text x="650" y="110" text-anchor="middle">Weak Lensing</text>
  
  <!-- Decision point -->
  <rect x="275" y="300" width="250" height="100" class="decision" />
  <text x="400" y="360" text-anchor="middle">Decision Point</text>
  
  <!-- Feedback loop -->
  <rect x="275" y="450" width="250" height="100" class="feedback" />
  <text x="400" y="510" text-anchor="middle">Feedback Loop</text>
  
  <!-- Arrows -->
  <line x1="150" y1="150" x2="275" y2="300" class="arrow" />
  <line x1="250" y1="150" x2="275" y2="300" class="arrow" />
  <line x1="550" y1="150" x2="275" y2="300" class="arrow" />
  <line x1="650" y1="150" x2="275" y2="300" class="arrow" />
  <line x1="400" y1="400" x2="400" y2="450" class="arrow" />
  <line x1="400" y1="550" x2="400" y2="600" class="arrow" />
</svg>
<figcaption>SVG scientific process diagram for Types of Gravitational Lensing</figcaption>
</figure>

1. **Strong Lensing**: This occurs when there is a significant mass, like a galaxy cluster, that can produce multiple images or arcs of a background object. The Horseshoe Einstein Ring is an example of strong lensing, where the light from a distant galaxy is bent into a nearly complete ring due to the precise alignment with the lensing galaxy.
...
<!-- SVG: SVG scientific process diagram for The Role of Hubble in Observational Astronomy -->
<figure>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
  <!-- Background -->
  ...
  <!-- Steps -->
  <text x="50" y="50" font-size="20" fill="black">1. HST Launch in 1990</text>
  <text x="50" y="100" font-size="20" fill="black">2. Equipped with Instruments</text>
  <text x="50" y="150" font-size="20" fill="black">3. Capturing Images</text>
  <text x="50" y="200" font-size="20" fill="black">4. Studying High-resolution Images</text>
  
  <!-- Decision Points -->
  <circle cx="400" cy="250" r="30" fill="#ffcc00" />
  <text x="380" y="260" font-size="18" fill="black">Decision Point</text>
  
  <!-- Feedback Loop -->
  <path d="M 400 280 Q 450 300 500 280" fill="none" stroke="blue" stroke-width="2" />
  <text x="460" y="290" font-size="18" fill="black">Feedback Loop</text>
</svg>
<figcaption>SVG scientific process diagram for The Role of Hubble in Observational Astronomy</figcaption>
</figure>
...
<!-- SVG: SVG scientific process diagram for Implications for Astrophysics -->
<figure>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
  <!-- Understanding Dark Matter -->
  <rect x="50" y="50" width="200" height="100" fill="#F9EBEA" stroke="#EC7063" stroke-width="2"/>
  <text x="150" y="110" fill="#EC7063" text-anchor="middle" font-family="Arial" font-size="16">Understanding Dark Matter</text>
  
  <!-- Gravitational Lensing -->
  <rect x="300" y="50" width="200" height="100" fill="#D5F5E3" stroke="#58D68D" stroke-width="2"/>
  <text x="400" y="110" fill="#58D68D" text-anchor="middle" font-family="Arial" font-size="16">Gravitational Lensing</text>
  
  <!-- Mapping Dark Matter -->
  <rect x="550" y="50" width="200" height="100" fill="#E8DAEF" stroke="#AF7AC5" stroke-width="2"/>
  <text x="650" y="110" fill="#AF7AC5" text-anchor="middle" font-family="Arial" font-size="16">Mapping Dark Matter</text>
  
  <!-- Decision Point -->
  <circle cx="400" cy="300" r="80" fill="#F9E79F" stroke="#F4D03F" stroke-width="2"/>
  <text x="400" y="300" fill="#F4D03F" text-anchor="middle" font-family="Arial" font-size="16">Decision Point</text>
  
  <!-- Feedback Loop -->
  <path d="M 250 100 Q 220 180 400 300" fill="none" stroke="#3498DB" stroke-width="2"/>
  <path d="M 550 100 Q 580 180 400 300" fill="none" stroke="#3498DB" stroke-width="2"/>
</svg>
<figcaption>SVG scientific process diagram for Implications for Astrophysics</figcaption>
</figure>
...
- [A Horseshoe Einstein Ring from Hubble Image Credit: ESA / Hubble & NASA Expla...](https://reentry.codl.fr/@apod/statuses/01K91NQXPP3BZ0DTQC85YA5XF2) — @apod on mastodon