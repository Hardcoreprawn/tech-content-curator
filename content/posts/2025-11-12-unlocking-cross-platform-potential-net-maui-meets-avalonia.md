...
- author: vyrotek
  platform: hackernews
  quality_score: 0.6
  url: https://avaloniaui.net/blog/net-maui-is-coming-to-linux-and-the-browser-powered-by-avalonia
summary: NET MAUI (Multi-platform App UI) with Linux and web browsers through the
...
title: 'Unlocking Cross-Platform Potential: .NET MAUI Meets Avalonia'
word_count: 1107
---
...
```mermaid
flowchart LR
    A[.NET MAUI] --> B[Avalonia UI framework]
    B --> C[Linux]
    B --> D[Web browsers]
    C --> E[Applications running on Linux]
    D --> F[Applications running on web browsers]
```
