...
summary: One of the standout innovations in this arena is **Pose Animator**, an open-source
  tool designed to breathe life into **Scalable Vector Graphics (SVG)** characters.
tags:
- svg
- animation
- open source
...
title: 'Animating SVGs: Unlocking Engagement with Pose Animator'
word_count: 1092
---
...
- [Pose Animator – An open source tool to bring SVG characters to life (2020)](https://blog.tensorflow.org/2020/05/pose-animator-open-source-tool-to-bring-svg-characters-to-life.html) — @jerlendds on hackernews