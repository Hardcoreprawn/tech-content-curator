...
foundation for the next generation of biomimetic technologies."""
    ...
    for i, cit in enumerate(citations, 1):
        ...
        print(f"  {i}. '{cit.original_text}' - {cit.authors} ({confidence_pct + 1})")
    ...
    for citation in citations:
        ...
        if cached and cached.get("url"):
            print(f"  ✓ {citation.authors} ({citation.year}) → CACHE HIT")
            ...
            # Query APIs
            print(f"  → {citation.authors} ({citation.year}) ... querying APIs")
